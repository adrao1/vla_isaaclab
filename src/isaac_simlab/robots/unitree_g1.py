...
# Start square to the table with the left arm in G1's natural nominal pose.
# The previous arm pose was found together with a rotated torso, so reusing it
# at zero torso yaw made the arm cross diagonally in front of the body.
...
UNITREE_G1 = RobotDefinition(
    ...
    left_hand_open_joint_positions=(0.0, 1.0, 0.18, 0.10, -0.12, 0.10, -0.12),
    left_hand_closed_joint_positions=(0.0, 0.10, 1.45, -1.35, -1.45, 0.10, -0.12),
